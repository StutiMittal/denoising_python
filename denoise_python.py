# -*- coding: utf-8 -*-
"""denoise_python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ABR0DBwyffmN6GC3_9yWTowtbLEwgdco
...
img = img_as_float(io.imread("/content/denoise.jpeg"))
#Need to convert to float as we will be doing math on the array

from scipy import ndimage as nd
gaussian_img = nd.gaussian_filter(img, sigma=3)
plt.imsave("/content/gaussian.jpg", gaussian_img)


median_img = nd.median_filter(img, size=3)
plt.imsave("/content/median.jpg", median_img)
...
plt.imsave("/content/NLM.jpg",denoise_img)